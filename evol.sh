...
##Database Details
dbhost='evosql.superthunder.com.ph';
dbuser='alliance2_evolutionvpn01';
dbpass='541983-KICKS';
dbname='alliance2_evolutionvpn01';
dbport='3306';
...
#       Setup by: Michael Bugayong			#
#       Server System: Evolution VPN 	    #
#            owner: Michael    		        #
#############################################'
}
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "https://raw.githubusercontent.com/reyluar18/evol/master/premiumconnection.sh"
echo "* * * * * /usr/bin/php /usr/sbin/kpn/connection.php >/dev/null 2>&1
* * * * * /bin/bash /usr/sbin/kpn/active.sh >/dev/null 2>&1
* * * * * /bin/bash /usr/sbin/kpn/inactive.sh >/dev/null 2>&1" | tee -a /var/spool/cron/root
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "https://raw.githubusercontent.com/reyluar18/evol/master/vipconnection.sh"
echo "* * * * * /usr/bin/php /usr/sbin/kpn/connection.php >/dev/null 2>&1
* * * * * /bin/bash /usr/sbin/kpn/active.sh >/dev/null 2>&1
* * * * * /bin/bash /usr/sbin/kpn/inactive.sh >/dev/null 2>&1" | tee -a /var/spool/cron/root
sed -i "s|DBHOST|$dbhost|g" /usr/sbin/kpn/connection.php
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "https://raw.githubusercontent.com/reyluar18/evol/master/privateconnection.sh"
echo "* * * * * /usr/bin/php /usr/sbin/kpn/connection.php >/dev/null 2>&1
* * * * * /bin/bash /usr/sbin/kpn/active.sh >/dev/null 2>&1
* * * * * /bin/bash /usr/sbin/kpn/inactive.sh >/dev/null 2>&1" | tee -a /var/spool/cron/root
sed -i "s|DBHOST|$dbhost|g" /usr/sbin/kpn/connection.php
